          ...
          title: Row(
            children: [
              ...
              InkWell(
                ...
                onTap: () => Get.toNamed(Routes.notificationsFormRoute),
              ),
            ],
          ),
          ...
          child: Row(
            children: [
              Text(
                ...
                style: TextStyle(
                  color:
                      element.statement.amount > 0 ? Colors.green : Colors.red,
                  fontWeight: FontWeight.bold,
                  fontSize: 15,
                ),
              ),
